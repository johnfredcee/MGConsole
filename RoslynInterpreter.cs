...
#pragma warning restore CS1591
	...
	public class RoslynInterpreter : ICommandInterpreter
	{
        ...
        public bool Execute(IConsoleOutput output, string command)
        {
            bool result = true;
            if (EchoEnabled)
		...
		public void Reset()
		{
			Globals = new ExpandoWrapper { self = new ExpandoObject() };
			ScriptOptions = ScriptOptions.Default.WithImports("System", "Microsoft.Xna.Framework");
			_typeLoader.Reset();
